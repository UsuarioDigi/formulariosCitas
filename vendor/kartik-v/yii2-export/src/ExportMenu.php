...
class ExportMenu extends GridView
{
    ...
    protected function setDefaultExportConfig()
    {
        ...
        $this->_defaultExportConfig = [
            ...
            self::FORMAT_CSV => [
                ...
                'alertMsg' => Yii::t('kvexport', 'El archivo de exportación en formato CSV se generará para su descarga.'),
            ...
            self::FORMAT_TEXT => [
                ...
                'alertMsg' => Yii::t('kvexport', 'El archivo de exportación en formato TEXTO se generará para su descarga.'),
                'mime' => 'text/plain',
                'extension' => 'txt',
                'writer' => self::FORMAT_CSV,
                'delimiter' => "\t",
            ...
            self::FORMAT_PDF => [
                ...
                'alertMsg' => Yii::t('kvexport', 'El archivo de exportación en formato PDF se generará para su descarga.'),
            ...
            self::FORMAT_EXCEL => [
                ...
                'alertMsg' => Yii::t('kvexport', 'El archivo de exportación en formato EXCEL 95+ (xls) se generará para su descarga.'),
            ...
            self::FORMAT_EXCEL_X => [
                ...
                'alertMsg' => Yii::t('kvexport', 'El archivo de exportación en formato EXCEL 2007+ (xlsx) se generará para su descarga. '),
    ...
    protected function registerAssets()
    {
        ...
        $this->messages += [
            'allowPopups' => Yii::t(
                'kvexport',
                'Desactiva cualquier bloqueador de ventanas emergentes en tu navegador para asegurar una descarga adecuada.'
            ),
            'confirmDownload' => Yii::t('kvexport', 'Está seguro de continuar?'),
            'downloadProgress' => Yii::t('kvexport', 'Generando el archivo de exportación. Por favor espere...'),
        ...
        foreach ($this->exportConfig as $format => $setting) {
			...
			'alertMsg' => isset($setting['alertMsg']) ? $setting['alertMsg'] : 'Mensaje de alerta predeterminado',
		]);
